...
weight_init = TruncatedNormal(mean=0.0, stddev=0.02,
                              seed=1337)  # Change the initializer Hyperparameter according to reference Paper
...
def build_generator(latent_size):
    ...
    cnn.add(Dense(384 * 4 * 4, input_dim=latent_size, activation='relu',
                  kernel_initializer=weight_init, bias_initializer='Zeros'))
    ...
    cls = Flatten()(Embedding(10, latent_size,
                              embeddings_initializer=weight_init)(image_class))
...
def build_discriminator():
    ...
    cnn.add(MinibatchDiscrimination(50, 30, init=weight_init))
    ...
    fake = Dense(1, activation='sigmoid', name='generation',
                 kernel_initializer=weight_init, bias_initializer='Zeros')(features)
